...
const typeMap = {
  ...
  "cyber-security-workshop": "technical",     // ← added here (optional but good practice)
  "murder-mystery": "fun",
  wikichase: "fun",
  debate: "fun",
...
export default function TechnicalEvents({ posts }) {
      ...
      <main className="pt-24 pb-16 px-4 md:px-8 xl:px-20">
        <div ref={headerRef} className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="mt-4 font-chakra text-white/60 max-w-3xl mx-auto text-lg">
            Code, compete, innovate — where logic meets creativity.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPosts.length > 0 ? (
            ...
            <div className="col-span-full text-center py-20">
              ...
              <p className="font-chakra text-white/50 mt-3">
                Technical events will be announced shortly.
              </p>
            </div>
          )}
        </div>
...
export async function getStaticProps() {
  try {
    ...
    return {
      ...
      revalidate: 60 * 60, // ISR – revalidate every hour (optional)
    };
  } catch (error) {
